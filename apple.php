...
<header id="header">
  ...
  <a href="cart/cart.php">
    ...
    <h2 style="text-align:center">Apple Phones</h2>
    ...
    ?>
        ...
        <div class="column">
            <div class="card">
                ...
                <p>Display: 6.5-inch Full HD+ AMOLED screen with 120Hz refresh rate
Processor: Qualcomm Snapdragon 888+ octa-core chipset
RAM: 8GB LPDDR5 RAM
Storage: 128GB UFS 3.1 internal storage (expandable up to 1TB via microSD)
Camera: Quad-camera setup with a 64MP main sensor, 12MP ultra-wide, 8MP telephoto, and 2MP depth sensor
Battery: 5,000mAh battery with 65W fast charging support
Operating System: Android 13 with custom UI skin</p>
